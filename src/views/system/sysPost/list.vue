  ...
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="岗位名称">
              <el-input v-model="searchObj.keyword" style="width: 20%" placeholder="岗位名称" />
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%">
      <el-form ref="dataForm" :model="sysPost" label-width="150px" size="small" style="padding-right: 40px;">
        <el-form-item label="岗位名称">
          <el-input v-model="sysPost.postName" />
        </el-form-item>
        ...
        <el-form-item label="排序">
          <el-input-number v-model="sysPost.sortValue" controls-position="right" :min="0" />
        </el-form-item>
        <el-form-item label="创建者">
        <el-input v-model="sysPost.createBy" />
      </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    // 添加
    savePost() {
      api.savePost(this.sysPost).then(response => {
    ...
    edit(id) {
      ...
      //   this.sysPost = response.data.data
      // })
      Object.assign(this.sysPost, this.list.find(role => role.id === id))
      this.dialogVisible = true
    },
    // 更新
    updatePost() {
